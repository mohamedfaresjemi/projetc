...
COMMANDE URGENTE!!!!
[Type: ARRET_URGENCE | Durée=3s | Vitesse=0 | Priorité=URGENTE]
...
[00:03:12] [URGENTE] AVANCER | duree=2s | vitesse=1.50
...
En cas d’obstacle :
Le robot génère automatiquement 3 commandes urgentes :
...
Uniquement si aucune commande du chemin ne rencontre d’obstacle
...
📦 Projet Robotique
 ┣ 📄 projetfinalrobotique.c   # Code source principal
 ┣ 📄 journal_robot.txt        # Journal généré automatiquement
 ┗ 📄 README.md                # Documentation du projet

🛠️ Compilation & Exécution
Compiler :
gcc projetfinalrobotique.c -o robot
...
Planification intelligente basée sur A* ou Dijkstra
